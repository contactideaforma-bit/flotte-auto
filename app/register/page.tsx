    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 16, fontWeight: 500, marginBottom: '1.25rem' }}>Créer un compte</h2>
          ...
          <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <input type="password" required placeholder="Minimum 6 caractères" value={password} onChange={e => setPassword(e.target.value)} />
            </div>
            <div>
              <label style={{ fontSize: 12, color: 'var(--text-secondary)', display: 'block', marginBottom: 5 }}>Confirmer le mot de passe</label>
